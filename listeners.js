...
var messageManager = (function () {
	...
	function sendToWeb(msg, key) {
		...
		console.log(
			"messageManager.sendToWeb called with message: " +
	...
	function sendTest(msg, key) {
		...
		console.log(
			"Frontend messageManager.sendTest called with message: " +
				JSON.stringify(messageData)
		);
	...
	function onMessageReceived(data) {
		...
		if (data[0].value === "terminated") {
			console.log(
				"App received terminated from backend ... doing nothing atm..."
			);
			...
			function (dir) {
				...
				try {
					...
					if (existingFile) {
						...
						dir.deleteFile(existingFile.fullPath, onDelete, err => {
							console.log(err);
						});
						return;
					}
...
var init = function () {
	...
	button1.addEventListener("click", function () {
		...
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button1),
			"myUDP"
		);
	});
	...
	button2.addEventListener("click", function () {
		...
		//modal.classList.add("fold-class");
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button2),
			"myUDP"
		);
	});
	button3.addEventListener("click", function () {
		...
		//modal.classList.add("fold-class");
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button3),
			"myUDP"
		);
	});
	button4.addEventListener("click", function () {
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button4),
			"myUDP"
		);
	});
	button5.addEventListener("click", function () {
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button5),
			"myUDP"
		);
	});
	button6.addEventListener("click", function () {
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button6),
			"myUDP"
		);
	});
	button7.addEventListener("click", function () {
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button7),
			"myUDP"
		);
	});
	button8.addEventListener("click", function () {
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button8),
			"myUDP"
		);
	});
	button9.addEventListener("click", function () {
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button9),
			"myUDP"
		);
	});
	button10.addEventListener("click", function () {
		messageManager.sendTest(
			JSON.stringify(configuration.buttonsSettings.Button10),
			"myUDP"
		);
	});
